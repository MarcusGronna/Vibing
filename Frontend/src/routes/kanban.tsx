...
import { TaskPriority, TaskStatus } from "../features/tasks/types/TaskItem";
        ...
        return (
            <div className="min-h-screen bg-neutral-100 p-4 sm:p-6 flex flex-col items-center justify-center">
                <div className="text-center max-w-md">
                    <p className="text-red-600 text-lg mb-4">Failed to load tasks: {(error as Error).message}</p>
                    <button
                        onClick={() => refetch()}
        ...
        <div className="min-h-screen bg-neutral-100 p-4 sm:p-6">
            <div className="max-w-7xl mx-auto">
                <header className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
                    ...
                    <button
                        onClick={() => refetch()}
                        className="px-4 py-2 rounded-md bg-blue-600 text-white font-medium text-sm hover:bg-blue-700">
                        Refresh
                    </button>
                </header>
